...
$string['addcomment'] = 'Hozzászólok';
$string['addimage'] = 'Képek hozzáadása';
...
$string['backtogallery'] = 'Vissza a galériához';
...
$string['commentcount'] = '{$a} hozzászólás';
...
$string['dirup'] = 'Fel';
$string['dirdown'] = 'Le';
$string['dirleft'] = 'Balra';
$string['dirright'] = 'Jobbra';
$string['displayinggallery'] = 'Képgaléria: {$a}';
$string['editimage'] = 'Kép szerkesztése';
$string['edit_choose'] = 'Válassz...';
...
$string['errornoimages'] = 'Ebben a galériában nincsenek képek';
$string['errornosearchresults'] = 'A keresés nem hozott találatot';
$string['erroruploadimage'] = 'The file you upload must be an image file';
$string['extendedinfo'] = 'Show extended image info';
$string['imageadd'] = 'Képek hozzáadása';
$string['imagecount'] = 'Image count';
$string['imagecounta'] = '{$a} kép';
$string['imagedirectory'] = 'Kép könyvtár';
...
$string['imagedownload'] = 'Kép letöltése';
...
$string['invalidlightboxgalleryid'] = 'Hibás galéria ID';
$string['lightboxgallery'] = 'Képgaléria';
$string['lightboxgallery:addcomment'] = 'Add comment to lightbox gallery';
$string['lightboxgallery:addinstance'] = 'Új képgaléria hozzáadása';
$string['lightboxgallery:addimage'] = 'Kép hozzáadása a galériához';
...
$string['modulenameplural'] = 'Képgalériák';
$string['modulenameshort'] = 'Galéira';
$string['modulenameadd'] = 'Képgaléria';
$string['newgallerycomments'] = 'Új galéria hozzászólások';
$string['norssfeedavailable'] = 'Feed not available';
$string['position_bottom'] = 'Lent';
$string['position_top'] = 'Fent';
...
$string['showall'] = 'Összes mutatása';
