...
$string['acceptablefiletypebriefing'] = 'Ha egyszerre több fájlt szeretnél feltölteni, akkor tömörítsd egy zip fájlba őket és azt töltsd fel. Az összes képfájl hozzá lesz adva a galériához.';
$string['addcomment'] = 'Hozzászólás';
$string['addimage'] = 'Képek hozzáadása';
$string['addimage_help'] = 'Képek keresése a saját gépen.

Egy zip fájlt is ki lehet választani. Feltöltés után a képek automatikusan hozzáadásra kerülnek a galériához.';
...
$string['displayinggallery'] = 'Aktuális galéria: {$a}';
...
$string['lightboxgallery'] = 'Lightbox Galéria';
$string['lightboxgallery:addcomment'] = 'Add comment to lightbox gallery';
$string['lightboxgallery:addinstance'] = 'Új Lightbox galéria hozzáadása';
$string['lightboxgallery:addimage'] = 'Add image to lightbox gallery';
$string['lightboxgallery:edit'] = 'Lightbox galéria szerkesztése';
...
$string['modulenameplural'] = 'Lightbox Galériák';
$string['modulenameshort'] = 'Galéria';
$string['modulenameadd'] = 'Lightbox galéria';
